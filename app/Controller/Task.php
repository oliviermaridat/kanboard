...
class Task extends Base
{
    ...
    public function readonly()
    {
        ...
        $milestonetasks = null;
        if (isset($links[\Kanboard\Model\TaskLink::LABEL_ISMILESTONE])) {
            $milestonetasks = $links[\Kanboard\Model\TaskLink::LABEL_ISMILESTONE];
            unset($links[\Kanboard\Model\TaskLink::LABEL_ISMILESTONE]);
        }
