...
class TaskModification extends Base
{
    ...
    public function prepare(array &$values)
    {
        ...
        $this->dateParser->convert($values, array('date_completed'));
        $this->removeFields($values, array('another_task', 'id'));
        $this->resetFields($values, array('date_due', 'date_started', 'date_completed', 'score', 'category_id', 'time_estimated', 'time_spent'));
